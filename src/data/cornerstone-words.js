...
if (typeof window !== 'undefined') {
    if (typeof window.CORNERSTONE_WORDS_SET === 'undefined') {
        window.CORNERSTONE_WORDS_SET = new Set(COMMON_WORDS_LIST.map(w => w.toLowerCase()));
    }
    CORNERSTONE_WORDS_SET = window.CORNERSTONE_WORDS_SET;
} else {
